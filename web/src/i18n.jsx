...
export const nl = {
  ...
  waitlist: {
    ...
    done: 'Genoteerd. Je hoort van ons zodra er iets te downloaden is.',
    note: 'We bewaren alleen je e-mailadres, en alleen hiervoor.',
    failed: 'Aanmelden lukte niet. Probeer het zo nog eens.',
    busy: 'Bezig...',
  },
  ...
  login: {
    ...
    prototypeNotice: 'Je account is echt. Wat je daarna ziet is nog demodata, want de koppelingen met Canvas, Teams en Magister bestaan nog niet.',
    invalidEmail: 'Vul een volledig e-mailadres in.',
    emptyPassword: 'Vul je wachtwoord in.',
    resetTitle: 'Wachtwoord vergeten',
    resetLead: 'Vul je e-mailadres in. Je krijgt een link waarmee je een nieuw wachtwoord kiest.',
    resetSubmit: 'Stuur de herstelmail',
    resetSent: 'Verstuurd. Kijk in je mail, ook bij spam. De link blijft een uur geldig.',
    resetDone: 'Je wachtwoord is aangepast. Log in met het nieuwe wachtwoord.',
    backToSignIn: 'Terug naar inloggen',
    ssoNotice: 'Inloggen met een schoolaccount komt later. Maak zolang een account met je e-mailadres.',
    signIn: 'Inloggen',
    signUp: 'Account aanmaken',
    name: 'Je naam',
    namePlaceholder: 'Voor- en achternaam',
    emptyName: 'Vul je naam in.',
    shortPassword: 'Kies een wachtwoord van minstens zes tekens.',
    busy: 'Bezig...',
    haveAccount: 'Heb je al een account?',
    signInInstead: 'Inloggen',
    createAccount: 'Maak er een aan',
    errors: {
      invalid: 'Dit adres en wachtwoord horen niet bij elkaar.',
      exists: 'Er bestaat al een account met dit adres. Log in.',
      weakPassword: 'Kies een wachtwoord van minstens zes tekens.',
      invalidEmail: 'Dit e-mailadres accepteert de server niet.',
      tooMany: 'Te veel pogingen. Wacht even en probeer het opnieuw.',
      samePassword: 'Kies een ander wachtwoord dan je vorige.',
      notConfigured: 'De verbinding met de database ontbreekt. Zet de omgevingsvariabelen goed.',
      confirmEmail: 'Je account staat klaar. Bevestig eerst het adres via de mail die we stuurden.',
      unknown: 'Er ging iets mis. Probeer het zo nog eens.',
    },
  ...
  newPassword: {
    ...
    lead: 'Kies een nieuw wachtwoord voor je account.',
    password: 'Nieuw wachtwoord',
    repeat: 'Herhaal het wachtwoord',
    placeholder: 'Minstens zes tekens',
    submit: 'Wachtwoord opslaan',
    busy: 'Bezig...',
    short: 'Kies een wachtwoord van minstens zes tekens.',
    mismatch: 'De twee wachtwoorden zijn niet gelijk.',
    checking: 'Even kijken of de link nog geldig is...',
    expiredTitle: 'Deze link werkt niet meer',
    expiredBody: 'Een herstellink is een uur geldig en werkt maar een keer. Vraag een nieuwe aan.',
    expiredAction: 'Nieuwe link aanvragen',
  },
  ...
  app: {
    ...
    loadFailed: 'Je gegevens konden niet geladen worden. Controleer je verbinding.',
    ...
    today: {
      ...
      timeline: 'Je dag',
      tomorrow: 'Morgen',
      tomorrowEmpty: 'Morgen heb je geen les.',
      deadline: 'Deadline',
      done: 'geweest',
    ...
    open: {
      canvas: 'Openen in Canvas',
      teams: 'Openen in Teams',
      magister: 'Openen in Magister',
      own: 'Van jezelf',
      note: 'Bundel schrijft niets terug, dus inleveren en reageren doe je in de bron.',
    },
    ...
    status: {
      ...
      graded: 'nagekeken',
      late: 'te laat',
      ownTick: 'je eigen vinkje',
      ownTickNote: 'Alleen voor jezelf. De bron weet hier niets van.',
      fromSource: 'volgens {source}',
      derived: 'Nog geen koppeling, dus deze status is afgeleid uit de deadline.',
    },
    ...
    grades: {
      ...
      period: 'Periode',
      periodAll: 'Hele jaar',
      periodNumber: 'Periode {number}',
      periodEmpty: 'Nog geen cijfers in deze periode.',
      yearAverage: 'Jaargemiddelde',
    ...
    attendance: {
      ...
      rule: 'Te laat telt als aanwezig. Een afmelding telt niet mee in het percentage.',
      perSubject: 'Per vak',
    ...
    own: {
      ...
      name: 'Naam',
      namePlaceholder: 'Bijvoorbeeld tandarts of dienst bij de zaak',
      day: 'Dag',
      from: 'Van',
      to: 'Tot',
      place: 'Waar',
      placePlaceholder: 'Optioneel',
      note: 'Notitie',
      notePlaceholder: 'Optioneel',
      weekly: 'Elke week herhalen',
      weeklyNote: 'Verschijnt dan in alle weken op dezelfde dag en tijd.',
      save: 'Opslaan',
      remove: 'Verwijderen',
      cancel: 'Annuleren',
      needName: 'Geef het een naam.',
      needEnd: 'De eindtijd moet na de begintijd liggen.',
      noEnd: 'Een herinnering heeft geen eindtijd.',
      hint: 'Klik op een lege plek in het raster om daar iets neer te zetten.',
      mine: 'Van jezelf',
      empty: 'Je hebt hier nog niets van jezelf staan.',
    },
    ...
    signal: {
      ...
      todayTitle: 'Twee dingen om op te letten',
      todayTitleOne: 'Eén ding om op te letten',
      todayLink: 'Bekijk in het rooster',
      more: 'en nog {count} vak',
      morePlural: 'en nog {count} vakken',
    },
...
export const en = {
  ...
  waitlist: {
    ...
    done: 'Noted. You will hear from us as soon as there is something to download.',
    note: 'We keep your email address only, and only for this.',
    failed: 'Signing up did not work. Please try again in a moment.',
    busy: 'One moment...',
  },
  ...
  login: {
    ...
    prototypeNotice: 'Your account is real. What you see afterwards is still demo data, because the links to Canvas, Teams and Magister do not exist yet.',
    invalidEmail: 'Enter a complete email address.',
    emptyPassword: 'Enter your password.',
    resetTitle: 'Forgot your password',
    resetLead: 'Enter your email address. You will get a link to choose a new password.',
    resetSubmit: 'Send the recovery mail',
    resetSent: 'Sent. Check your mail, including spam. The link stays valid for an hour.',
    resetDone: 'Your password has been changed. Log in with the new one.',
    backToSignIn: 'Back to logging in',
    ssoNotice: 'Logging in with a school account comes later. Create an account with your email address for now.',
    signIn: 'Log in',
    signUp: 'Create account',
    name: 'Your name',
    namePlaceholder: 'First and last name',
    emptyName: 'Enter your name.',
    shortPassword: 'Choose a password of at least six characters.',
    busy: 'One moment...',
    haveAccount: 'Already have an account?',
    signInInstead: 'Log in',
    createAccount: 'Create one',
    errors: {
      invalid: 'That address and password do not go together.',
      exists: 'An account with this address already exists. Log in instead.',
      weakPassword: 'Choose a password of at least six characters.',
      invalidEmail: 'The server does not accept this email address.',
      tooMany: 'Too many attempts. Wait a moment and try again.',
      samePassword: 'Choose a different password than your previous one.',
      notConfigured: 'The database connection is missing. Set the environment variables.',
      confirmEmail: 'Your account is ready. Confirm your address using the mail we sent.',
  ...
  newPassword: {
    ...
    busy: 'One moment...',
    short: 'Choose a password of at least six characters.',
    mismatch: 'The two passwords are not the same.',
    checking: 'Checking whether the link is still valid...',
    expiredTitle: 'This link no longer works',
    expiredBody: 'A recovery link is valid for an hour and works only once. Request a new one.',
    expiredAction: 'Request a new link',
  },
  ...
  app: {
    ...
    retry: 'Retry',
    loading: 'Loading...',
    loadFailed: 'Your data could not be loaded. Check your connection.',
    ...
    open: {
      ...
      teams: 'Open in Teams',
      magister: 'Open in Magister',
      own: 'Yours',
      note: 'Bundel writes nothing back, so handing in and replying happens in the source.',
    },
    ...
    status: {
      ...
      graded: 'graded',
      late: 'late',
      ownTick: 'your own tick',
      ownTickNote: 'Just for you. The source knows nothing about it.',
      fromSource: 'according to {source}',
      derived: 'No connection yet, so this status is worked out from the deadline.',
    },
    ...
    grades: {
      ...
      period: 'Term',
      periodAll: 'Whole year',
      periodNumber: 'Term {number}',
      periodEmpty: 'No grades in this term yet.',
    ...
    attendance: {
      ...
      rule: 'Late counts as present. A reported absence is left out of the percentage.',
    ...
    own: {
      add: 'Add',
      addTitle: 'Add something of your own',
      editTitle: 'Edit',
      kind: 'What is it',
      kinds: {
      ...
      name: 'Name',
      namePlaceholder: 'For example dentist or a shift at work',
      day: 'Day',
      from: 'From',
      to: 'To',
      place: 'Where',
      ...
      weeklyNote: 'It then appears in every week on the same day and time.',
      save: 'Save',
      remove: 'Remove',
      cancel: 'Cancel',
      needName: 'Give it a name.',
      needEnd: 'The end time has to be after the start time.',
      noEnd: 'A reminder has no end time.',
      hint: 'Click an empty spot in the grid to put something there.',
      mine: 'Yours',
      empty: 'You have nothing of your own here yet.',
    },
    ...
    signal: {
      ...
      todayTitle: 'Two things to watch',
      todayTitleOne: 'One thing to watch',
      todayLink: 'See it in the timetable',
      more: 'and {count} more subject',
      morePlural: 'and {count} more subjects',
    },
